        ...
        <div class="card-body">
            <form action="" method="post">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" name="st_Precio_por_unidad" id="st_Precio_por_unidad" aria-describedby="helpId" placeholder="Ingrese su precio por unidad">
                        <br>
                  <label for="st_N_de_existencia" class="form-label">Numero de existencia</label>
                  <input type="text" class="form-control" name="st_N_de_existencia" id="st_N_de_existencia" aria-describedby="helpId" placeholder="Ingrese su numero de existencia">
                        <br>
                  <label for="	st_Categoria" class="form-label">Categoria</label>
                  <input type="email" class="form-control" name="	st_Categoria" id="	st_Categoria" aria-describedby="helpId" placeholder="Ingrese su categoria">
                        <br>
                  <label for="st_Cantidad_total_en_existencia" class="form-label">Cantidad total en existencia</label>
                  <input type="text" class="form-control" name="st_Cantidad_total_en_existencia" id="st_Cantidad_total_en_existencia" aria-describedby="helpId" placeholder="Ingrese cantidad total en existencia">
                        <br>
