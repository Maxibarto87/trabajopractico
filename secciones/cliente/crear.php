        ...
        <div class="card-body">
            <form action="" method="post">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" name="cl_CUIT" id="cl_CUIT" aria-describedby="helpId" placeholder="Ingrese Nombre de Categoria">
                  <br>
                  <label for="cl_Telefono" class="form-label">Teléfono</label>
                  <input type="text" class="form-control" name="cl_Telefono" id="cl_Telefono" aria-describedby="helpId" placeholder="Ingrese Descripcion de Categoria">
                  <br>
